...
# the total number of distinct sequences of rolls possible such that the following 
...
#  if the value of the iᵗʰ roll is equal to the value of the jᵗʰ roll, then abs(i 
# - j) > 2. 
#  
# 
...
# Input: n = 4
# Output: 184
# Explanation: Some of the possible sequences are (1, 2, 3, 4), (6, 1, 2, 3), (1
# , 2, 3, 1), etc.
